...
import googleLogo from "@/assets/images/구글 로고.svg";
    ...
    return (
        <div className="relative min-h-screen overflow-hidden">
            ...
            <div className="flex flex-col items-center gap-3 md:gap-4 mt-12 md:mt-24 w-full">
                <button className="w-4/6 h-10 md:h-12 border text-sm md:text-base bg-[#ffffff] font-medium text-[#666666] border-[#dddddd] rounded-md flex items-center gap-20">
                    <Image src={googleLogo} width={24} height={24} alt="googleLogo" className="ml-8"/>
                    <span>Google 계정으로 시작</span>
                </button>
                <button className="w-4/6 h-10 md:h-12 border text-sm md:text-base bg-[#FFEB00] font-medium text-[#333333] border-[#dddddd] rounded-md flex items-center gap-20">
